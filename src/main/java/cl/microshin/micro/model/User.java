...
@Entity 
@Table(name = "DatosUsuario") //Crea una base de datos con este nombre, usualmente se separara con un _.
...
public class User {
    ...
    @GeneratedValue(strategy = GenerationType.AUTO) //Estrategia de generacion de valor, en este caso al ser un ID, es clave primaria y auto-incrementable.
    private int ID;
